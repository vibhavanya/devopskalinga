...
<div class="container">
  <h2>Add Album</h2>
  <p>Please add the details of the album to enjoy...</p>
  <form action="/addalbum" class="was-validated" method="post">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="albumName" placeholder="Enter albumName" name="albumName" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
